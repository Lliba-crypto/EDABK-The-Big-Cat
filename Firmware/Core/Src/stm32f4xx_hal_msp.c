...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  if(hi2c->Instance==I2C1)
  {
    ...
    PB9     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(FRONT_IMU_GPIO_Port, FRONT_IMU_Pin);

    HAL_GPIO_DeInit(FRONT_IMUB9_GPIO_Port, FRONT_IMUB9_Pin);
  ...
  else if(hi2c->Instance==I2C2)
  {
    ...
    PB11     ------> I2C2_SDA
    */
    HAL_GPIO_DeInit(RIGHT_SCREEN_GPIO_Port, RIGHT_SCREEN_Pin);

    HAL_GPIO_DeInit(RIGHT_SCREENB11_GPIO_Port, RIGHT_SCREENB11_Pin);
  ...
  else if(hi2c->Instance==I2C3)
  {
    ...
    PA8     ------> I2C3_SCL
    */
    HAL_GPIO_DeInit(LEFT_GPIO_Port, LEFT_Pin);

    HAL_GPIO_DeInit(LEFTA8_GPIO_Port, LEFTA8_Pin);
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  if(htim_encoder->Instance==TIM3)
  {
    ...
    PB5     ------> TIM3_CH2
    */
    HAL_GPIO_DeInit(GPIOB, LEFT_ENCODER_Pin|LEFT_ENCODERB5_Pin);
  ...
  else if(htim_encoder->Instance==TIM4)
  {
    ...
    PB7     ------> TIM4_CH2
    */
    HAL_GPIO_DeInit(GPIOB, RIGHT_ENCODER_Pin|RIGHT_ENCODERB7_Pin);
